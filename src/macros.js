...
export const MACROS_OVERRIDE = new Map([
  ...
  ['le', {type: 'operator', operatorType: 'infix', value: '≤'}],
  ['ge', {type: 'operator', operatorType: 'infix', value: '≥'}],
  ['ne', {type: 'operator', operatorType: 'infix', value: '≠'}],
  ['overline', {type: 'operator', operatorType: 'infix', value: '˙'}],
